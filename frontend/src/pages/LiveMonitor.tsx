  ...
  return (
    <PageWrapper>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        >
          <motion.span
            animate={{ scale: wsConnected ? [1, 1.4, 1] : 1 }}
              ...
              {displaySrc ? (
                ...
                >
                  ...
                  <p style={{ color: '#475569', fontSize: '0.72rem', margin: 0, textAlign: 'center' }}>
                    Detected vehicles will be boxed — moving or parked
                  </p>
                </motion.div>
              )}
            </AnimatePresence>
            ...
            <AnimatePresence>
              {processing && (
                <motion.div
                  ...
                  style={{ position: 'absolute', inset: 0, background: 'rgba(0,0,0,0.6)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 14 }}
                >
                  <motion.div
                    animate={{ rotate: 360 }}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <div className="card" style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            <motion.div
              ...
              style={{ border: '2px dashed var(--border)', borderRadius: 12, padding: '1.25rem', textAlign: 'center', cursor: 'pointer' }}
            ...
            <AnimatePresence>
              {processing && (
                <motion.div
                  ...
                  style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: '0.8rem', color: 'var(--text-secondary)', background: 'var(--bg-subtle)', borderRadius: 10, padding: '8px 12px', overflow: 'hidden' }}
                >
          ...
          {/* Detection stats */}
          <div className="card">
            <div style={{ fontWeight: 700, fontSize: '0.875rem', color: 'var(--text-body)', marginBottom: 12 }}>Detection Results</div>
            <AnimatePresence mode="wait">
              {lastResult ? (
                <motion.div
                  key="results"
                ...
                >
                  ...
                  <div style={{ display: 'flex', gap: 12, marginTop: 4, fontSize: '0.7rem', color: 'var(--text-faint)' }}>
                    <span style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                      <span style={{ width: 10, height: 10, borderRadius: 2, background: '#00CC44', display: 'inline-block' }} /> Moving
                    </span>
                    <span style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                      <span style={{ width: 10, height: 10, borderRadius: 2, background: '#FF4444', display: 'inline-block' }} /> Parked / violation
                    </span>
                  </div>
                </motion.div>
              ) : (
        ...
        <div style={{ marginTop: 12, paddingTop: 12, borderTop: '1px solid var(--border-light)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 8 }}>
            {(currentCongestion?.readings ?? []).slice(0, 8).map((r: Record<string, unknown>, i: number) => (
              <motion.div key={i} whileHover={{ scale: 1.04 }} transition={{ duration: 0.12 }}
